...
def bifurcation_diagram(f, rmin, rmax, nr=200, n=500, x0=0.57, discard=0.5, ax=None):
    ...
    iterated n times from x0, and the last (1 - discard) fraction of
    every orbit (the part that has converged onto the attractor) is
    plotted against r. Returns the arrays (rs, xs) that make up the diagram.
