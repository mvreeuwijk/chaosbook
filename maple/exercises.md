...
approach. They are collected here, one page per chapter, together with the Maple
worksheets and data files needed to work through them.

::::{grid} 1 2 2 3
:gutter: 3

:::{grid-item-card} A start at the end
:link: exercises_phenomenon
:link-type: doc
:::

:::{grid-item-card} Chaos in Iterative Maps
:link: exercises_disc1d
:link-type: doc
:::

:::{grid-item-card} Discrete mappings of higher order
:link: exercises_disc2d
:link-type: doc
:::

:::{grid-item-card} Continuous Systems
:link: exercises_cont1d
:link-type: doc
:::

:::{grid-item-card} Two-dimensional continuous systems
:link: exercises_cont2d
:link-type: doc
:::

:::{grid-item-card} Chaos in continuous systems
:link: exercises_cont3d
:link-type: doc
:::

:::{grid-item-card} Fractal geometries
:link: exercises_fractals
:link-type: doc
:::
